...
def main():
    ...
    for font_config in configs.font_configs:
        font_service.classify_patch_glyph_files(font_config)
        font_service.verify_patch_glyph_files(font_config)
        alphabet_group, glyph_file_paths_group = font_service.collect_glyph_files(font_config)
